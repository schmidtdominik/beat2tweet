...
STANFORD_CORENLP_4_5_2_JAR = 'stanford-corenlp-4.5.2.jar'
...
class PTBTokenizer:
    ...
    def tokenize(self, captions_for_audio):
        cmd = ['java', '-cp', STANFORD_CORENLP_4_5_2_JAR, \
        ...
        token_lines,err = p_tokenizer.communicate(input=sentences.rstrip())
        print(err)
